...
//        BoardHelpers.executeSequenceOfMoves(board1, List.of("e2e4"));
    ...
    public void testMoveGeneration1() {
        List<Pair<String, String>> FENs = List.of(
                ...
                new Pair<>("8/8/8/7Q/k2Pp3/8/8/3K4 b - d3 0 1", "Kb4, Kb3, Ka3, e3, d3 e.p."),
                new Pair<>("r1b1kb1r/pp1npppp/1qn5/3pP3/B1pP4/2P2N1P/PP3PP1/RNBQK2R b KQkq d3 0 10", "d3 e.p., Qb5, Qb3, Qb4, Qa6, Qc7, Qd8, Qa5, Qc5, Qxb2, Qxd4, Nd8, Nb4, Na5, Nb8, Nxe5, Nxd4, a6, a5, Nf6, Nxe5, Nc5, Nb8, e6, f6, f5, g6, g5, h6, h5, Rb8, Kd8, Rg8")
        );
